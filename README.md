...
```
python NFM_exp.py --dataset frappe --hidden_factor 64 --layers "[64]" --keep_prob "[0.8,0.5]" --loss_type square_loss --activation relu --pretrain 0 --optimizer Adagrad --lr 0.05 --batch_norm 1 --verbose 1 --early_stop 1 --epoch 200
```
